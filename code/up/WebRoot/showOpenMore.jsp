...
.modify{display: inline-block;width: 18px;height: 18px;background: url(./images/calendar_nextmonth.png) no-repeat center #ffffff; cursor: pointer;border: 1px solid #D6D6D6; box-shadow: 0 0 2px rgba(0,0,0,.15);position: absolute;border-radius: 2px;left: 210px;top: 25px;}
			  ...
			  <c:forEach items="${result.dataList }" var="Img">
			       <div class="grid_1_of_4 images_1_of_4">
						<div class="transform">
							 ...
							 <ul class="modify_tow">
							 	<li class="added" name="${Img.photo }" myurl="${Img.saveFile }"><img src="images/iconfont-xiugai.png" alt="">修改</li>
							 	<li class="delete" name="${Img.photo }" myurl="${Img.saveFile }"><img src="images/delete2.png" alt="" >删除</li>
<!-- 							 	href="servlet/Delete?photo=${Img.photo}&url=${Img.saveFile}&isadmin=1"> -->
							 </ul>
						</div>
					    <a class="fancybox" href="servlet/showDetailPage?imgName=${Img.photo}&isadmin=1&url=${Img.saveFile}" data-fancybox-group="gallery">
	...
	// 弹框插件
		...
		$(".added").click(function(event) {
			...
			var btnFn = function() {
				...
				$.ajax({
					type: "GET",
    				url: "/wps/myportal/up/servlet/UpPhotoname",
