  ...
  <head>
	...
	<script  type="text/javascript">
		...
		function changeIframeSrc(a){
			...
			if(a=="intranet"){  //如果点击"内网"
				iframeMoth.attr("src","firstPage100.jsp");
			}else if(a=="intra_HomePage"){//如果点击"首页"
				iframeMoth.attr("src","secondPage100.jsp");
			}else{ //否则就是点击 文件
				iframeMoth.attr("src","threePage100.jsp?a="+a);
			}
		}
