...
@Repository
public class DeviceOfflineActionDaoImpl implements IDeviceOfflineActionDao{
	...
	public Map<String, Object> getPropertes(){
		...
		String eng;
		try {
			chi = new String(resouce.getString("DeviceOfflineActionChinese").getBytes("ISO-8859-1"),"UTF-8");
			eng = new String(resouce.getString("DeviceOfflineActionEnglish").getBytes("ISO-8859-1"),"UTF-8");
