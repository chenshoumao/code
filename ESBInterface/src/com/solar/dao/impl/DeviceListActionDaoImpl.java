...
@Repository
public class DeviceListActionDaoImpl implements IDeviceListActionDao{
	...
	public Map<String, Object> getPropertes(){
		...
		String eng;
		try {
			chi = new String(resouce.getString("DeviceListActionChinese").getBytes("ISO-8859-1"),"UTF-8");
			eng = new String(resouce.getString("DeviceListActionEnglish").getBytes("ISO-8859-1"),"UTF-8");
