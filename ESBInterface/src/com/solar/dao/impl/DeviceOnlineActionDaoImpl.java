...
@Repository
public class DeviceOnlineActionDaoImpl implements IDeviceOnlineActionDao{
	...
	public Map<String, Object> getPropertes(){
		...
		String eng;
		try {
			chi = new String(resouce.getString("DeviceOnlineActionChinese").getBytes("ISO-8859-1"),"UTF-8");
			eng = new String(resouce.getString("DeviceOnlineActionEnglish").getBytes("ISO-8859-1"),"UTF-8");
